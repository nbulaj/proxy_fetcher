...
module ProxyFetcher
  ...
  module Providers
    ...
    require File.dirname(__FILE__) + "/proxy_fetcher/providers/proxy_list_download_http"
    require File.dirname(__FILE__) + "/proxy_fetcher/providers/proxy_list_download_https"
    require File.dirname(__FILE__) + "/proxy_fetcher/providers/proxy_list_download_socks4"
    require File.dirname(__FILE__) + "/proxy_fetcher/providers/proxy_list_download_socks5"
